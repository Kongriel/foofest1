...
const FollowButton = ({ onClick }) => {
  ...
  return (
    <div ref={containerRef} onClick={onClick} className="z-30 flex justify-center items-center relative w-40 h-20 cursor-pointer">
      <div ref={circleRef} className="absolute flex justify-center items-center h-16 w-40 text-sm rounded-md border-2 hover:border-blue-600 border-gray-500"></div>
